...
.. code-block:: bash
   ...
   (master) $ git checkout -b some-descriptive-branch-name
   (some-descriptive-branch-name) $ git pull origin the-branch-you-want-to-pull

   # clean up commit history
   (some-descriptive-branch-name) $ git rebase -i master
